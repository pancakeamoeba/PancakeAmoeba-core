...
contract VaultVenus is VaultAMVController, IAMVStrategy, ReentrancyGuardUpgradeable {
    ...
    VaultVenusBridgeOwner private constant VENUS_BRIDGE_OWNER = VaultVenusBridgeOwner(0xec7097CE1f04ec6e4a69157F41f12B6d75935A04); // require mainet
    ...
    function initialize(address _token, address _vToken) external initializer {
        ...
        venusBridge = IVaultVenusBridge(0xc4C533935Bb64fA19968dE551899B7A4393174BC); // require mainnet
    ...
    function setMinter(address newMinter) public override onlyOwner {
        VaultAMVController.setMinter(newMinter);
    }
    ...
    function setAMVChef(IAMVChef newChef) public override onlyOwner {
        ...
        VaultAMVController.setAMVChef(IAMVChef(newChef));
    }
